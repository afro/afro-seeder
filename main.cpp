...
static const string mainnet_seeds[] = {"seed1.afrofoundation.org", "seed2.afrofoundation.org", ""};
static const string testnet_seeds[] = {"seed1.afrofoundation.org", "seed2.afrofoundation.org", ""};

static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("kjy2eqzk4zwi5zd3.onion", 22516), true);
  }
  do {
